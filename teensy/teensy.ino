...
int odriveCalibration[ODRIVE_CALIBRATION_COUNT] = {ODriveArduino::AXIS_STATE_CLOSED_LOOP_CONTROL};
...
void setup() {
    ...
    */
    ...
    odriveFront.run_state(MOTOR_1, ODriveArduino::AXIS_STATE_CLOSED_LOOP_CONTROL, false, 0);
    Serial.println("cali 1");
    odriveSerialFront.flush();
    odriveFront.run_state(MOTOR_2, ODriveArduino::AXIS_STATE_CLOSED_LOOP_CONTROL, false, 0);
    Serial.println("cali 2");
    odriveSerialFront.flush(); 
    odriveBack.run_state(MOTOR_1, ODriveArduino::AXIS_STATE_CLOSED_LOOP_CONTROL, false, 0);
    Serial.println("cali 3");
    odriveSerialBack.flush();
    odriveBack.run_state(MOTOR_2, ODriveArduino::AXIS_STATE_CLOSED_LOOP_CONTROL, false, 0);
    odriveSerialBack.flush();
