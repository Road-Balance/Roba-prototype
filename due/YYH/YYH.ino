...
void loop()
{
    ...
    // 추후 axisLeftY +- p*axisRightX의 값이 axisLeftY의 부호를 그대로 따라가야 함.
    // 1/32767 = 0.0000305...
    float p = 0.0000305f * axisLeftY; 
    float FL, RL, FR, RR;
    ...
    while (true)
    {
        ...
        if (len == 9)
        {
            raw_a1y = (buf[3] * 255 + buf[4]) - 32767;
            raw_a2x = (buf[5] * 255 + buf[6]) - 32767;
            axisLeftY = (raw_a1y) * 0.0001f;
            axisRightX = (raw_a2x) * 0.0001f;
